...
from models.protocols.MtaAndMtaWcMessages import MtaChallenge, MtaCommitmentAlice, MtaCommitmentBob, MtaProoveForChallengeAlice, MtaProoveForChallengeBob
...
class MessageDTO(BaseModel):
    ...
    data: Union[TransactionDTO, TransactionResponse, user_key_generation_share, 
                Commitment, value_knowledge_zk_proof, MtaChallenge, MtaCommitmentAlice,
                  MtaCommitmentBob, MtaCommitmentAlice, MtaProoveForChallengeBob]