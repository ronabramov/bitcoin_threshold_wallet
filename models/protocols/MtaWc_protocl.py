...
from models.protocols import BobZKProofMtaWc , AliceZKProof
...
class MtaWcProtocolWithZKP:
    ...
    def __init__(self, alice_public_share : user_public_share, 
        ...
        self.Bob_Alg_r = BobZKProofMtaWc.pick_r(Bob_Alg_Public_key.n)
    ...
    def bob_verify_a_commiting_encrypting_b(self, b :int, enc_a : EncryptedNumber, challenge, proof_of_a : AliceZKProof_Proof_For_Challenge,
        ...
        c_ab = MtaWcProtocolWithZKP.homomorphic_exponentiation(enc_a, b)  # Computes E(a^b)
        enc_result = c_ab + enc_beta_prime
        b_and_beta_prime_commitment = BobZKProofMtaWc.prover_generates_commitment(settings=prover_settings, enc_a_cipher=enc_a_cipher)
    ...
    def alice_finalize(self, proof_for_challenge : Bob_ZKProof_Proof_For_Challenge, commitment : Bob_ZKProof_ProverCommitment, enc_a,
                        enc_result, settings : Bob_ZKProof_RegMta_Settings, challenge, alice_paillier_secret_key : paillier.PaillierPrivateKey):
